...
// 1. كود منظومة الرجوع المتطورة للجوال والكمبيوتر
const backNavCode = `
(function () {
...
// 2. كتابة ملف public/back-navigation.js
fs.writeFileSync('public/back-navigation.js', backNavCode, 'utf8');
console.log('✅ Created public/back-navigation.js successfully.');

// 3. ربطه في صفحة public/index.html
let html = fs.readFileSync('public/index.html', 'utf8');
if (!html.includes('back-navigation.js')) {
    html = html.replace('</body>', '<script src="back-navigation.js"></script>\n</body>');
    fs.writeFileSync('public/index.html', html, 'utf8');
    console.log('✅ Linked back-navigation.js into index.html successfully.');
} else {
    console.log('ℹ️ Already linked in index.html.');
}
